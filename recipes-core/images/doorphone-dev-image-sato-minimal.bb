# core-image-minimal support basic command
#
# Debug tool

require recipes-core/images/core-image-minimal.bb

EXTRA_IMAGE_FEATURES += " package-management debug-tweaks eclipse-debug ssh-server-openssh"
...
IMAGE_INSTALL += "${I2C_TOOLS_SUPPORT} ${TIME_ZONE_SUPPORT} ${UTILS_TOOLS} ${TTF_TOOLS} ${NETWORK_TOOLS} ${RTL_FIRMWARE} ${FBTEST} ${FEH_IMG}"
